...
using Azihub.Appstract.Tests.MockGrpc;
...
using SystemCompressLevel = System.IO.Compression.CompressionLevel;
...
namespace Azihub.Appstract.Tests
{
    public class GrpcTests
    {
        ...
        [Fact]
        public void GrpcServiceWithOptionsTest()
        {
            GrpcServiceOptions options = new GrpcServiceOptions()
            {
                CompressionProviders = new List<ICompressionProvider>() {
                    new GzipCompressionProvider(SystemCompressLevel.NoCompression)
                },
                EnableDetailedErrors = true,
                IgnoreUnknownServices = false,
                MaxReceiveMessageSize = 16_777_216,
                MaxSendMessageSize = 16_777_216
            };
            ...
            IServiceCollection services = new ServiceCollection();
            services.AddAndConfigureCodeFirstGrpc(options);
        }
    }
    /*
    [DataContract]
...
#pragma warning disable CS0618 // Type or member is obsolete
            ...
            BinaryFormatterMarshallerFactory.I_Promise_Not_To_Do_This = true; // signed: Mason Chase
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            _server.Services.AddCodeFirst<ApplyServices>();
